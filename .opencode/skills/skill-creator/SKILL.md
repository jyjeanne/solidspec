...
name: skill-creator
description: >
  Guide for creating effective skills for software development. Use this skill when:
...
license: MIT
compatibility: Works with Claude Code, open Code and similar AI coding assistants that support Agent Skills.
metadata:
  author: babylon
  version: "1.1.0"
