...
pub mod skill_files {
    pub const SKILL_MD: &str = include_str!("../../templates/apex/SKILL.md");

    pub const STEP_00_INIT: &str = include_str!("../../templates/apex/steps/step-00-init.md");
    pub const STEP_00B_BRANCH: &str = include_str!("../../templates/apex/steps/step-00b-branch.md");
    ...
    pub const STEP_01_ANALYZE: &str = include_str!("../../templates/apex/steps/step-01-analyze.md");
    pub const STEP_02_PLAN: &str = include_str!("../../templates/apex/steps/step-02-plan.md");
    pub const STEP_03_EXECUTE: &str = include_str!("../../templates/apex/steps/step-03-execute.md");
    pub const STEP_04_VALIDATE: &str =
        include_str!("../../templates/apex/steps/step-04-validate.md");
    pub const STEP_05_EXAMINE: &str = include_str!("../../templates/apex/steps/step-05-examine.md");
    pub const STEP_06_RESOLVE: &str = include_str!("../../templates/apex/steps/step-06-resolve.md");
    pub const STEP_07_TESTS: &str = include_str!("../../templates/apex/steps/step-07-tests.md");
    pub const STEP_08_RUN_TESTS: &str =
        include_str!("../../templates/apex/steps/step-08-run-tests.md");
    pub const STEP_09_FINISH: &str = include_str!("../../templates/apex/steps/step-09-finish.md");

    pub const TMPL_00_CONTEXT: &str = include_str!("../../templates/apex/templates/00-context.md");
    pub const TMPL_01_ANALYZE: &str = include_str!("../../templates/apex/templates/01-analyze.md");
    pub const TMPL_02_PLAN: &str = include_str!("../../templates/apex/templates/02-plan.md");
    pub const TMPL_03_EXECUTE: &str = include_str!("../../templates/apex/templates/03-execute.md");
    pub const TMPL_04_VALIDATE: &str =
        include_str!("../../templates/apex/templates/04-validate.md");
    pub const TMPL_05_EXAMINE: &str = include_str!("../../templates/apex/templates/05-examine.md");
    pub const TMPL_06_RESOLVE: &str = include_str!("../../templates/apex/templates/06-resolve.md");
    pub const TMPL_07_TESTS: &str = include_str!("../../templates/apex/templates/07-tests.md");
    pub const TMPL_08_RUN_TESTS: &str =
        include_str!("../../templates/apex/templates/08-run-tests.md");
    pub const TMPL_09_FINISH: &str = include_str!("../../templates/apex/templates/09-finish.md");
...
pub fn extract_skill(target_dir: &Path) -> Result<()> {
    ...
    write_script(
        &scripts_dir.join("setup-templates.sh"),
        skill_files::SETUP_TEMPLATES_SH,
    )?;
    write_script(
        &scripts_dir.join("update-progress.sh"),
        skill_files::UPDATE_PROGRESS_SH,
    )?;
...
pub fn build_solidspec_context(feature_dir: &Path, feature_id: &str) -> Result<String> {
    ...
    let plan_summary = if plan_path.exists() {
        ...
        let truncated = lines.len() == 60 && content.lines().count() > 60;
    ...
    let (pending_tasks, pending_count, completed_count) = if tasks_path.exists() {
        ...
        let pending: Vec<&str> = content.lines().filter(|l| is_pending_task(l)).collect();
        let completed = content.lines().filter(|l| is_completed_task(l)).count();
...
mod tests {
    ...
    fn context_includes_pending_tasks_only() {
        ...
        assert!(
            !ctx.contains("T002"),
            "completed T002 must not appear in pending list"
        );
    }
    ...
    fn context_plan_truncated_at_60_lines() {
        ...
        assert!(
            ...
            "plan >60 lines must show truncation notice"
        );
    ...
    fn sync_leaves_unlisted_tasks_unchanged() {
        let dir = TempDir::new().unwrap();
        make_tasks_md(dir.path(), &["- [ ] T001 Task A", "- [ ] T002 Task B"]);
    ...
    fn sync_empty_log_returns_zero_counts() {
        ...
        assert!(
            read_tasks(dir.path()).contains("- [ ] T001"),
