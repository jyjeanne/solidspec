...
Cohesion: 0.06
Nodes (31): filter_all_phases(), filter_apex_driven_apex_at_correct_position(), filter_apex_driven_from_tasks_to_analyze(), filter_apex_driven_has_apex_not_implement(), filter_apex_driven_only_apex(), filter_existing_schemas_unchanged_by_apex_addition(), filter_from_after_to_errors(), filter_from_plan_to_tasks() (+23 more)
...
Cohesion: 0.08
Nodes (14): all_agent_ids(), copilot_uses_agent_md_extension(), ide_agents_have_requires_cli_false(), kimi_uses_skill_md_extension(), Vec, Option, Result, run() (+6 more)
...
Cohesion: 0.19
Nodes (20): AgentConfig, cli_agents_have_requires_cli_true(), find_agent(), Option, apex_command_file_contains_apex_workflow_text(), command_files_contain_compliance_guardrails(), copilot_creates_agent_md_and_prompt_md(), DetectedAgent (+12 more)
...
Cohesion: 0.33
Nodes (10): full_pipeline_scaffold_generates_all_artifacts(), pipeline_dry_run_output_contains_dry_run_marker(), pipeline_idsd_generates_intent_before_spec(), pipeline_intent_apex_uses_single_feature_dir(), pipeline_new_ignores_stale_feature_env_var(), pipeline_sdd_unchanged_no_intent_md(), pipeline_status_shows_artifact_table(), Command (+2 more)
...
- **Why does `ExtensionManifest` connect `Community 20` to `Community 19`?**
  _High betweenness centrality (0.055) - this node is a cross-community bridge._
- **Why does `FanOutConfig` connect `Community 2` to `Community 0`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `ExtensionEntry` connect `Community 14` to `Community 19`?**
